                    ...
                    <form method="POST" action="{{ route('clients.store') }}" class="space-y-6">
                        ...
                        <div class="border-t pt-6 mt-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="registration_number" name="registration_number" type="text" class="mt-1 block w-full" :value="old('registration_number')" maxlength="255" />
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="tax_identifier" name="tax_identifier" type="text" class="mt-1 block w-full" :value="old('tax_identifier')" maxlength="255" />
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="vat_id" name="vat_id" type="text" class="mt-1 block w-full" :value="old('vat_id')" maxlength="32" />
                        ...
                        <div class="border-t pt-6 mt-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="address_line1" name="address_line1" type="text" class="mt-1 block w-full" :value="old('address_line1')" maxlength="255" />
                                <x-input-error class="mt-2" :messages="$errors->get('address_line1')" />
                            </div>

                            <div class="mt-4">
                                <x-input-label for="address_line2" value="Address Line 2 (Optional)" />
                                <x-text-input id="address_line2" name="address_line2" type="text" class="mt-1 block w-full" :value="old('address_line2')" maxlength="255" />
                                <x-input-error class="mt-2" :messages="$errors->get('address_line2')" />
                            </div>

                            <div class="mt-4">
                                <x-input-label for="city" value="City" />
                                <x-text-input id="city" name="city" type="text" class="mt-1 block w-full" :value="old('city')" maxlength="255" />
                                <x-input-error class="mt-2" :messages="$errors->get('city')" />
                            </div>

                            <div class="mt-4">
                                <x-input-label for="postal_code" value="Postal Code" />
                                <x-text-input id="postal_code" name="postal_code" type="text" class="mt-1 block w-full" :value="old('postal_code')" maxlength="32" />
